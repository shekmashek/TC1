...
import { eventTemplates } from '../utils/eventTemplates.js';
...
export const initializeProject = async ({ dataDispatch, uiDispatch }, payload, user, existingTiersData, allTemplates) => {
  try {
    ...
    const allOfficialTemplates = [...officialTemplatesData.personal, ...officialTemplatesData.professional, ...eventTemplates];
